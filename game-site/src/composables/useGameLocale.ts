...
const copy = {
  ko: {
    ...
    titles: { 'number-guessing': '숫자 맞히기', 'number-baseball': '숫자 야구', reaction: '반응속도 테스트', 'tic-tac-toe': '틱택토', snake: '뱀 게임' },
    descriptions: { 'number-guessing': '열 번 안에 1부터 100 사이의 숫자를 맞혀 보세요.', 'number-baseball': '스트라이크와 볼 힌트로 숨겨진 세 자리 숫자를 맞혀 보세요.', reaction: '신호가 나타난 순간 최대한 빠르게 반응해 보세요.', 'tic-tac-toe': '한 기기에서 두 명이 번갈아 즐기는 3×3 게임입니다.', snake: '먹이를 먹고 몸을 키워 최고 점수에 도전하세요.' },
  },
  en: {
    ...
    titles: { 'number-guessing': 'Number Guessing', 'number-baseball': 'Number Baseball', reaction: 'Reaction Test', 'tic-tac-toe': 'Tic-Tac-Toe', snake: 'Snake' },
