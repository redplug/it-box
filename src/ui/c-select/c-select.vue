      ...
      >
        <div flex-1 truncate>
          <slot name="displayed-value">
            <input v-if="searchable && isOpen" ref="searchInputRef" v-model="searchQuery" type="text" placeholder="검색..." class="search-input" w-full lh-normal color-current @input="onSearchInput">
