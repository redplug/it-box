...
const copy = {
  ko: {
    ...
    titles: { 'number-guessing': '숫자 맞히기', reaction: '반응속도 테스트', 'tic-tac-toe': '틱택토' },
    descriptions: { 'number-guessing': '열 번 안에 1부터 100 사이의 숫자를 맞혀 보세요.', reaction: '신호가 나타난 순간 최대한 빠르게 반응해 보세요.', 'tic-tac-toe': '한 기기에서 두 명이 번갈아 즐기는 3×3 게임입니다.' },
  },
  en: {
    ...
    titles: { 'number-guessing': 'Number Guessing', reaction: 'Reaction Test', 'tic-tac-toe': 'Tic-Tac-Toe' },
    descriptions: { 'number-guessing': 'Guess a number between 1 and 100 in ten attempts.', reaction: 'React as quickly as possible when the signal appears.', 'tic-tac-toe': 'A local two-player 3×3 game.' },
  },
} as const;
